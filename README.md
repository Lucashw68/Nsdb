...
Si le VPS répond `command not found: npx`, configurez le chargement de Node dans le shell SSH non interactif :
...
Ou utilisez directement le binaire Supabase installé dans le projet distant :
