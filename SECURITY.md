...
NSDB is preparing its next 1.0 release candidate. Security fixes target the current development branch and the most recent published package version, if one exists. Older pre-release versions may require upgrading rather than receiving a backport.
